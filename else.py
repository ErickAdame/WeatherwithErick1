...
cell_value_pitt = str(data6.iloc[5, 2])
cell_value_roa = str(data6.iloc[6, 2])
cell_value_nash = str(data6.iloc[4, 2])
cell_value_lou = str(data6.iloc[3, 2])
cell_value_stl = str(data6.iloc[7, 2])
cell_value_was = str(data.iloc[41, 2])
cell_value_braw = str(data6.iloc[0,2])
cell_value_cle = str(data6.iloc[1,2])
...
pitt_weather = str(data6.iloc[5,4])
roa_weather = str(data6.iloc[6,4])
lou_weather = str(data6.iloc[3,4])
nash_weather = str(data6.iloc[4,4])
stl_weather = str(data6.iloc[7,4])
was_weather = str(data.iloc[41,4])
braw_weather = str(data6.iloc[0,4])
cle_weather = str(data6.iloc[1,4])
...
cle_image_file = base_directory + weather_image_mapping.get(cle_weather, "Wind.png")
...
cleveland = 25  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textboxf = slide.shapes[cleveland].text_frame
...
was = 25  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textbox14 = slide.shapes[was].text_frame
...
for slide in presentation.slides:
    for shape in slide.shapes:
        ...
        elif shape.name == "cle_icon":
            shape.element.getparent().remove(shape.element)
            slide.shapes.add_picture(cle_image_file, shape.left, shape.top, shape.width, shape.height)
