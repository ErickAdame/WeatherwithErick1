...
#HIGH TEMPS
sat_value_alb = str(data.iloc[0, 2])
sat_value_buf = str(data.iloc[7, 2])
sat_value_syr = str(data.iloc[39, 2])
sat_value_bos = str(data.iloc[4, 2])
sat_value_nyc = str(data.iloc[27, 2])
sat_value_phl = str(data.iloc[32, 2])
sat_value_col = str(data.iloc[13, 2])
sat_value_was = str(data.iloc[41, 2])

sun_value_alb = str(data.iloc[0, 8])
sun_value_buf = str(data.iloc[7, 8])
sun_value_syr = str(data.iloc[39, 8])
sun_value_bos = str(data.iloc[4, 8])
sun_value_nyc = str(data.iloc[27, 8])
sun_value_phl = str(data.iloc[32, 8])
sun_value_col = str(data.iloc[13, 8])
sun_value_was = str(data.iloc[41, 8])

sat_value_sac = str(data.iloc[35, 2]) 
sat_value_lax = str(data.iloc[22, 2])
sat_value_las = str(data.iloc[20, 2])
sat_value_phx = str(data.iloc[33, 2])
sat_value_san = str(data.iloc[36, 2])

sun_value_sac = str(data.iloc[35, 8]) 
sun_value_lax = str(data.iloc[22, 8])
sun_value_las = str(data.iloc[20, 8])
sun_value_phx = str(data.iloc[33, 8])
sun_value_san = str(data.iloc[36, 8])

sat_value_min = str(data.iloc[25, 2]) 
sat_value_des = str(data.iloc[15, 2])
sat_value_chi = str(data.iloc[11, 2])
sat_value_grr = str(data.iloc[18, 2])
sat_value_det = str(data.iloc[16, 2])
sat_value_cinn = str(data.iloc[12, 2])
sat_value_clt = str(data.iloc[10, 2])
sat_value_atl = str(data.iloc[1, 2])
sat_value_wil = str(data.iloc[42, 2])
sat_value_char = str(data.iloc[9, 2])
sat_value_sav = str(data.iloc[38, 2])
sat_value_mem = str(data.iloc[23, 2])
sat_value_dal = str(data.iloc[14, 2])
sat_value_new = str(data.iloc[26, 2])
sat_value_tam = str(data.iloc[40, 2])
sat_value_mia = str(data.iloc[24, 2])

sun_value_min = str(data.iloc[25, 8]) 
sun_value_des = str(data.iloc[15, 8])
sun_value_chi = str(data.iloc[11, 8])
sun_value_grr = str(data.iloc[18, 8])
sun_value_det = str(data.iloc[16, 8])
sun_value_cinn = str(data.iloc[12, 8])
sun_value_clt = str(data.iloc[10, 8])
sun_value_atl = str(data.iloc[1, 8])
sun_value_wil = str(data.iloc[42, 8])
sun_value_char = str(data.iloc[9, 8])
sun_value_sav = str(data.iloc[38, 8])
sun_value_mem = str(data.iloc[23, 8])
sun_value_dal = str(data.iloc[14, 8])
sun_value_new = str(data.iloc[26, 8])
sun_value_tam = str(data.iloc[40, 8])
sun_value_mia = str(data.iloc[24, 8])


#WEATHER CONDITIONS
alb_weather_sat = str(data.iloc[0,4])
buf_weather_sat  = str(data.iloc[7,4])
syr_weather_sat  = str(data.iloc[39,4])
bos_weather_sat  = str(data.iloc[4,4])
nyc_weather_sat  = str(data.iloc[27,4])
phl_weather_sat  = str(data.iloc[32,4])
col_weather_sat  = str(data.iloc[13,4])
was_weather_sat  = str(data.iloc[41,4])

alb_weather_sun = str(data.iloc[0,9])
buf_weather_sun = str(data.iloc[7,9])
syr_weather_sun = str(data.iloc[39,9])
bos_weather_sun = str(data.iloc[4,9])
nyc_weather_sun = str(data.iloc[27,9])
phl_weather_sun = str(data.iloc[32,9])
col_weather_sun = str(data.iloc[13,9])
was_weather_sun = str(data.iloc[41,9])

los_weather_sat = str(data.iloc[22,4])
san_weather_sat = str(data.iloc[36,4])
sac_weather_sat = str(data.iloc[35,4])
las_weather_sat = str(data.iloc[20,4])
phx_weather_sat = str(data.iloc[33,4])

los_weather_sun = str(data.iloc[22,9])
san_weather_sun = str(data.iloc[36,9])
sac_weather_sun = str(data.iloc[35,9])
las_weather_sun = str(data.iloc[20,9])
phx_weather_sun = str(data.iloc[33,9])

cin_weather_sat = str(data.iloc[12,4])
des_weather_sat = str(data.iloc[15,4])
min_weather_sat = str(data.iloc[25,4])
chi_weather_sat = str(data.iloc[11,4])
grr_weather_sat = str(data.iloc[18,4])
det_weather_sat = str(data.iloc[16,4])
sav_weather_sat = str(data.iloc[38,4])
char_weather_sat = str(data.iloc[9,4])
wil_weather_sat = str(data.iloc[42,4])
clt_weather_sat = str(data.iloc[10,4])
atl_weather_sat = str(data.iloc[1,4])
tam_weather_sat = str(data.iloc[40,4])
mem_weather_sat = str(data.iloc[23,4])
dal_weather_sat = str(data.iloc[14,4])
new_weather_sat = str(data.iloc[26,4])
mia_weather_sat = str(data.iloc[24,4])

cin_weather_sun = str(data.iloc[12,9])
des_weather_sun = str(data.iloc[15,9])
min_weather_sun = str(data.iloc[25,9])
chi_weather_sun = str(data.iloc[11,9])
grr_weather_sun = str(data.iloc[18,9])
det_weather_sun = str(data.iloc[16,9])
sav_weather_sun = str(data.iloc[38,9])
char_weather_sun = str(data.iloc[9,9])
wil_weather_sun = str(data.iloc[42,9])
clt_weather_sun = str(data.iloc[10,9])
atl_weather_sun = str(data.iloc[1,9])
tam_weather_sun = str(data.iloc[40,9])
mem_weather_sun = str(data.iloc[23,9])
dal_weather_sun = str(data.iloc[14,9])
new_weather_sun = str(data.iloc[26,9])
mia_weather_sun = str(data.iloc[24,9])
