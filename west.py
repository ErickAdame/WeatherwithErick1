...
cell_value_braw = str(data4.iloc[0, 2])
...
braw_weather = str(data4.iloc[0,4])
...
braw_image_file = base_directory + weather_image_mapping.get(braw_weather, "Wind.png")
...
# Get the current day of the week as an integer (0 = Monday, 1 = Tuesday, ..., 6 = Sunday)
...
slide_width_points = slide_width_inch * 72
slide_height_points = slide_height_inch * 72

# Convert points to EMUs (1 point = 12700 EMUs)
width = int(slide_width_points * 12700)
height = int(slide_height_points * 12700)

# Define a dictionary mapping days of the week to image file paths
day_to_image = {
    0: "/Users/erick/Desktop/Weather_Graphics/7_Day_Templates/Tue_7Day.png",
    1: "/Users/erick/Desktop/Weather_Graphics/7_Day_Templates/Wed_7Day.png",
    2: "/Users/erick/Desktop/Weather_Graphics/7_Day_Templates/Thu_7Day.png",
    3: "/Users/erick/Desktop/Weather_Graphics/7_Day_Templates/Fri_7Day.png",
    4: "/Users/erick/Desktop/Weather_Graphics/7_Day_Templates/Sat_7Day.png",
    5: "/Users/erick/Desktop/Weather_Graphics/7_Day_Templates/Sun_7Day.png",
    6: "/Users/erick/Desktop/Weather_Graphics/7_Day_Templates/Mon_7Day.png"
}

# Use the current day to fetch the corresponding image file path
background_image = day_to_image.get(current_day)

# Now use this 'background_image' variable to set the background of your slide
slide.background.fill.background()
slide.background.fill.solid()
slide.background.fill.fore_color.rgb = RGBColor(255, 255, 255)  # Set background color
# Add the picture to the slide
picture = slide.shapes.add_picture(background_image, 0, 0, width, height)
...
brawley = 20  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textbox13 = slide.shapes[brawley].text_frame
...
textbox13.clear()
textbox13.text = cell_value_braw
