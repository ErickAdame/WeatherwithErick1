...
city_list = ["Cleveland", "Washington dc", "Grand Rapids", "Dallas", "Nashville", "Indianapolis", "West Palm Beach"]
...
for url in range(len(url_list)):
    ...
    apparent_T.append(round(forecast['data'][1]['app_min_temp']))
...
city_list_added = ["seattle", "san francisco", "denver", "saint louis, mo", "nashville", "louisville", "roanoke", "pittsburgh", "cleveland, oh", "brawley, ca"]
url = "https://api.weatherbit.io/v2.0/forecast/daily"
key = "85a65933d3894f0d9c7194ffa8098565"
units = "&units=I"
