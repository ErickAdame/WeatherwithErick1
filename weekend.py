...
clt2 = 28  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textbox14a = slide.shapes[clt2].text_frame

atl2 = 8  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textbox15a = slide.shapes[atl2].text_frame

sav2 = 32  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textbox16a = slide.shapes[sav2].text_frame

mem2 = 20  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textbox17a = slide.shapes[mem2].text_frame

dal2 = 16  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textbox18a = slide.shapes[dal2].text_frame

new2 = 12  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textbox19a = slide.shapes[new2].text_frame

tam2 = 24  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textbox20a = slide.shapes[tam2].text_frame

mia2 = 4  # Textbox index is 0-based, so textbox 9 corresponds to index 8
textbox21a = slide.shapes[mia2].text_frame
